...
class Register extends Component{
    ...
    saveUser= (e) =>{
        e.preventDefault();
        let user ={userid:this.state.userid,firstname:this.state.firstname,lastname:this.state.lastname,email:this.state.email,password:this.state.password,mobileNumber:this.state.mobileNumber,userRole:this.state.userRole};
                        ...
                        <h3 className = "text-center">User Registration</h3>
                          <div className = "card-body">
                              ...
                              <div className="form-group">
                                  ...
                                  <input placeholder="UserRole" name="userRole" className="form-control" value={this.state.userRole} onChange={this.changeUserRoleHandler}/>
                                  </div>
